/**
 * Unit prices in EUR. The server copy in `prices.server.ts` re-exports this map and is
 * the authoritative source at checkout — client-sent prices are always ignored.
...
export const priceOf = (id: string): number => PRODUCT_PRICES[id] ?? 0;
